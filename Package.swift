...
//                .product(name: "SSH2", package: "libssh2-apple"),
                .product(name: "Clibgit2", package: "LibGit2-On-iOS-thebaselab", condition: .when(platforms: [.iOS])),
                .product(name: "Clibgit2macos", package: "libgit2-apple", condition: .when(platforms: [.macOS])),
